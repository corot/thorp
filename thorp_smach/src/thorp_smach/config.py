...
PICKING_MAX_FAILURES = 5  # picking failures allowed from current picking location (resets upon moving)
...
GRIPPER_TIGHTENING = 0.003  # additional gripper closing to tighten grasped objects
MAX_ARM_REACH = 0.3
TRAY_SIDE_X = 0.14
TRAY_SIDE_Y = 0.14
TRAY_DEPTH = 0.02
