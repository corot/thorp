...
WP_REACHED_THRESHOLD = 0.5  # we consider a waypoint reached when we pass by at least this distance
...
PICKING_DIST_TO_TABLE = 0.13  # ideal picking distance to the table, as close as possible without risk
